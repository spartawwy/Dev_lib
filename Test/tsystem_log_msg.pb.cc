...
void protobuf_ShutdownFile_tsystem_5flog_5fmsg_2eproto() {
  delete LogMessage::default_instance_;
}

#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
void protobuf_AddDesc_tsystem_5flog_5fmsg_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

#else
void protobuf_AddDesc_tsystem_5flog_5fmsg_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_tsystem_5flog_5fmsg_2eproto);
}

#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_tsystem_5flog_5fmsg_2eproto_once_);
void protobuf_AddDesc_tsystem_5flog_5fmsg_2eproto() {
  ::google::protobuf::::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_tsystem_5flog_5fmsg_2eproto_once_,
                 &protobuf_AddDesc_tsystem_5flog_5fmsg_2eproto_impl);
}
#else
// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_tsystem_5flog_5fmsg_2eproto {
  StaticDescriptorInitializer_tsystem_5flog_5fmsg_2eproto() {
    protobuf_AddDesc_tsystem_5flog_5fmsg_2eproto();
  }
} static_descriptor_initializer_tsystem_5flog_5fmsg_2eproto_;
#endif
...
const LogMessage& LogMessage::default_instance() {
  ...
  protobuf_AddDesc_tsystem_5flog_5fmsg_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_tsystem_5flog_5fmsg_2eproto();
#endif
