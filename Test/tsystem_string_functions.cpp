...
std::vector<std::string> TSystem::utility::split(const std::string& source, const std::string& seperator, 
...
std::string&   TSystem::utility::replace_all(std::string&   str, const   std::string&   old_value, const   std::string&   new_value)   
{   
    while(true)   
    {   
...
std::string&   TSystem::utility::replace_all_distinct(std::string&   str, const   std::string&   old_value, const  std::string&   new_value)   
{   
